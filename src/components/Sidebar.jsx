      ...
      <>
       <div className='flex justify-between items-center'>
          ...
          <TooltipComponent content="Menu" position="BottomCenter">
            <button type="button" onClick={() => setActiveMenu((prevActiveMenu)=>!prevActiveMenu)} className="text-xl rounded-full p-3 hover:bg-light-gray mt-4 block ">{/*md:hidden has been removed due to issue on lg screen*/}
              <MdOutlineCancel />
            </button>
          </TooltipComponent>
        </div>
